...
return [
    ...
    'payment'          => [
        'default' => [
            ...
            'appid'     => env('EXT_WECHAT_PAYMENT_APPID', ''),
            'mch_id'     => env('EXT_WECHAT_PAYMENT_MCH_ID', 'your-mch-id'),
            'mch_key'        => env('EXT_WECHAT_PAYMENT_KEY', 'key-for-signature'),
            'ssl_key'  => env('EXT_WECHAT_PAYMENT_CERT_PATH', 'path/to/cert/apiclient_cert.pem'),    // XXX: 绝对路径！！！！
            'ssl_cer'   => env('EXT_WECHAT_PAYMENT_KEY_PATH', 'path/to/cert/apiclient_key.pem'),      // XXX: 绝对路径！！！！
    ...
    'work'             => [
        'default' => [
            'appid'  => env('EXT_WECHAT_WORK_CORP_ID'),
            'agent_id' => env('EXT_WECHAT_WORK_AGENT_ID', 100020),
            'appsecret'   => env('EXT_WECHAT_WORK_AGENT_CONTACTS_SECRET', ''),
            //...
        ],
    ],
];