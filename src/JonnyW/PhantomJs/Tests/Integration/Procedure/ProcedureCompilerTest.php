...
use zxf\JonnyW\PhantomJs\Http\Request;
use zxf\JonnyW\PhantomJs\Procedure\ProcedureCompiler;
...
/** +++++++++++++++++++++++++++++++++++ **/
    ...
    public function testProcedureIsLoadedFromCacheIfCacheIsEnabled()
    {
        ...
        $renderer = $this->getMock('zxf\JonnyW\PhantomJs\Template\TemplateRendererInterface');
