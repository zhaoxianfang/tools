...
namespace zxf\Laravel\Modules\Facades;

use Illuminate\Support\Facades\Facade;
use zxf\Laravel\Modules\Commands\Database\MigrateFreshCommand;
use zxf\Laravel\Modules\Commands\Database\MigrateRefreshCommand;
use zxf\Laravel\Modules\Commands\Database\MigrateResetCommand;
 ...
 * @method static \zxf\Laravel\Modules\Module find(string $name)
 * @method static \zxf\Laravel\Modules\Module findOrFail(string $name)
