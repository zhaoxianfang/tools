...
class Word
{
     ...
     */
    public function __construct(?string $file = null, array $paperOptions = [])
    {
     ...
     * @return $this
     */
    public function addTable($alignment, callable $tableOperations)
    {
    ...
    public function addHeader($headerText, $align = 'center')
    {
        ...
        $style = ['alignment' => $align]; // 设置页眉内容居中对齐
