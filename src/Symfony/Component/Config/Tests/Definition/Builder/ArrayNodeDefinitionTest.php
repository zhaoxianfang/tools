...
use zxf\Symfony\Component\Config\Definition\Builder\ArrayNodeDefinition;
use zxf\Symfony\Component\Config\Definition\Processor;
use zxf\Symfony\Component\Config\Definition\Builder\ScalarNodeDefinition;
use zxf\Symfony\Component\Config\Definition\Exception\InvalidDefinitionException;
...
class ArrayNodeDefinitionTest extends TestCase
{
    ...
    public function testNestedPrototypedArrayNodes()
    {
        ...
        $this->assertInstanceOf('zxf\Symfony\Component\Config\Definition\PrototypedArrayNode', $node);
        $this->assertInstanceOf('zxf\Symfony\Component\Config\Definition\PrototypedArrayNode', $node->getPrototype());
    }
