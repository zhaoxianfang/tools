...
use zxf\Symfony\Component\Config\Definition\Builder\NodeBuilder as BaseNodeBuilder;
use zxf\Symfony\Component\Config\Definition\Builder\VariableNodeDefinition as BaseVariableNodeDefinition;
...
class NodeBuilderTest extends TestCase
{
    ...
    public function testNumericNodeCreation()
    {
        ...
        $this->assertInstanceOf('zxf\Symfony\Component\Config\Definition\Builder\IntegerNodeDefinition', $node);

        $node = $builder->floatNode('bar')->min(3.0)->max(5.0);
        $this->assertInstanceOf('zxf\Symfony\Component\Config\Definition\Builder\FloatNodeDefinition', $node);
    }
}
