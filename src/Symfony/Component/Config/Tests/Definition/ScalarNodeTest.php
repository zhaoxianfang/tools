...
namespace zxf\Symfony\Component\Config\Tests\Definition;
...
class ScalarNodeTest extends TestCase
{
    ...
    public function testNormalizeThrowsExceptionWithoutHint()
    {
        ...
        if (method_exists($this, 'expectException')) {
            $this->expectException('zxf\Symfony\Component\Config\Definition\Exception\InvalidTypeException');
            $this->expectExceptionMessage('Invalid type for path "test". Expected scalar, but got array.');
        } else {
            $this->setExpectedException('zxf\Symfony\Component\Config\Definition\Exception\InvalidTypeException', 'Invalid type for path "test". Expected scalar, but got array.');
        }
