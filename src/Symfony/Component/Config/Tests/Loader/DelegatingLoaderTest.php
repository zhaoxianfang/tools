...
use zxf\Symfony\Component\Config\Loader\DelegatingLoader;
...
class DelegatingLoaderTest extends TestCase
{
    ...
    {
        $loader1 = $this->getMockBuilder('zxf\Symfony\Component\Config\Loader\LoaderInterface')->getMock();
    ...
    {
        $loader = $this->getMockBuilder('zxf\Symfony\Component\Config\Loader\LoaderInterface')->getMock();
