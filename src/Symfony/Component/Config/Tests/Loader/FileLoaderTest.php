...
namespace zxf\Symfony\Component\Config\Tests\Loader;

use PHPUnit\Framework\TestCase;
use zxf\Symfony\Component\Config\FileLocator;
use zxf\Symfony\Component\Config\Loader\FileLoader;
...
class FileLoaderTest extends TestCase
{
    ...
    {
        $locatorMock = $this->getMockBuilder('zxf\Symfony\Component\Config\FileLocatorInterface')->getMock();

        $locatorMockForAdditionalLoader = $this->getMockBuilder('zxf\Symfony\Component\Config\FileLocatorInterface')->getMock();
        ...
        try {
            ...
            $this->assertInstanceOf('zxf\Symfony\Component\Config\Exception\FileLoaderImportCircularReferenceException', $e, '->import() throws a FileLoaderImportCircularReferenceException if the resource is already loading');
        }
