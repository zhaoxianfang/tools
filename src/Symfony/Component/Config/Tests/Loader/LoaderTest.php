...
class LoaderTest extends TestCase
{
    ...
    {
        $resolver = $this->getMockBuilder('zxf\Symfony\Component\Config\Loader\LoaderResolverInterface')->getMock();
    ...
    {
        $resolvedLoader = $this->getMockBuilder('zxf\Symfony\Component\Config\Loader\LoaderInterface')->getMock();
