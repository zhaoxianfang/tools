...
namespace zxf\Symfony\Component\Config\Tests\Resource;

use PHPUnit\Framework\TestCase;
use zxf\Symfony\Component\Config\Resource\ClassExistenceResource;
use zxf\Symfony\Component\Config\Tests\Fixtures\Resource\ConditionalClass;
use zxf\Symfony\Component\Config\Tests\Fixtures\BadParent;
...
class ClassExistenceResourceTest extends TestCase
{
    ...
    {
        $res = new ClassExistenceResource('zxf\Symfony\Component\Config\Tests\Fixtures\BarClass');
...
EOF
    ...
    {
        $res = new ClassExistenceResource('zxf\Symfony\Component\Config\Tests\Resource\ClassExistenceResourceTest');
