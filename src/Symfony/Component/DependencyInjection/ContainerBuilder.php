...
namespace zxf\Symfony\Component\DependencyInjection;
...
use zxf\Symfony\Component\DependencyInjection\Compiler\Compiler;
...
use zxf\Symfony\Component\DependencyInjection\Compiler\ResolveEnvPlaceholdersPass;
use zxf\Symfony\Component\DependencyInjection\Exception\BadMethodCallException;
...
use zxf\Symfony\Component\DependencyInjection\Exception\ServiceCircularReferenceException;
use zxf\Symfony\Component\DependencyInjection\Exception\ServiceNotFoundException;
use zxf\Symfony\Component\DependencyInjection\Extension\ExtensionInterface;
...
use zxf\Symfony\Component\Config\Resource\ClassExistenceResource;
use zxf\Symfony\Component\Config\Resource\ComposerResource;
use zxf\Symfony\Component\Config\Resource\DirectoryResource;
use zxf\Symfony\Component\Config\Resource\FileExistenceResource;
use zxf\Symfony\Component\Config\Resource\FileResource;
use zxf\Symfony\Component\Config\Resource\GlobResource;
use zxf\Symfony\Component\Config\Resource\ReflectionClassResource;
use zxf\Symfony\Component\Config\Resource\ResourceInterface;
use zxf\Symfony\Component\DependencyInjection\LazyProxy\Instantiator\InstantiatorInterface;
use zxf\Symfony\Component\DependencyInjection\LazyProxy\Instantiator\RealServiceInstantiator;
use zxf\Symfony\Component\DependencyInjection\ParameterBag\ParameterBagInterface;
use zxf\Symfony\Component\EventDispatcher\ContainerAwareEventDispatcher;
use zxf\Symfony\Component\ExpressionLanguage\Expression;
use zxf\Symfony\Component\ExpressionLanguage\ExpressionFunctionProviderInterface;
...
class ContainerBuilder extends Container implements TaggedContainerInterface
{
    ...
    public function __construct(ParameterBagInterface $parameterBag = null)
    {
        ...
        $this->trackResources = interface_exists('zxf\Symfony\Component\Config\Resource\ResourceInterface');
    ...
    private function getExpressionLanguage()
    {
        if (null === $this->expressionLanguage) {
            if (!class_exists('zxf\Symfony\Component\ExpressionLanguage\ExpressionLanguage')) {
