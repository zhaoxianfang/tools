...
namespace zxf\Symfony\Component\DependencyInjection\Dumper;

use zxf\Symfony\Component\DependencyInjection\Argument\ArgumentInterface;
...
use zxf\Symfony\Component\DependencyInjection\Compiler\AnalyzeServiceReferencesPass;
...
use zxf\Symfony\Component\DependencyInjection\Exception\EnvParameterException;
...
use zxf\Symfony\Component\DependencyInjection\LazyProxy\PhpDumper\DumperInterface as ProxyDumper;
use zxf\Symfony\Component\DependencyInjection\LazyProxy\PhpDumper\NullDumper;
use zxf\Symfony\Component\DependencyInjection\ExpressionLanguage;
use zxf\Symfony\Component\ExpressionLanguage\Expression;
use zxf\Symfony\Component\HttpKernel\Kernel;
...
EOTXT;
    ...
    private function generateProxyClasses()
    {
        ...
        $strip = '' === $this->docStar && method_exists('zxf\Symfony\Component\HttpKernel\Kernel', 'stripComments');
...
EOF;
    ...
    {
        $bagClass = $this->container->isCompiled() ? 'use zxf\Symfony\Component\DependencyInjection\ParameterBag\FrozenParameterBag;' : 'use zxf\Symfony\Component\DependencyInjection\ParameterBag\\ParameterBag;';
