...
use zxf\Symfony\Component\DependencyInjection\Compiler\AutowireRequiredMethodsPass;
use zxf\Symfony\Component\DependencyInjection\Compiler\AutowirePass;
use zxf\Symfony\Component\DependencyInjection\Compiler\ResolveClassPass;
use zxf\Symfony\Component\DependencyInjection\ContainerBuilder;
use zxf\Symfony\Component\DependencyInjection\Exception\AutowiringFailedException;
...
use zxf\Symfony\Component\DependencyInjection\Tests\Fixtures\includes\FooVariadic;
...
class AutowirePassTest extends TestCase
{
    ...
    {
        $container = new ContainerBuilder();
        $container->register('deprecated', 'zxf\Symfony\Component\DependencyInjection\Tests\Fixtures\DeprecatedClass')->setDeprecated(true);
        $container->register('foo', __NAMESPACE__.'\Foo');
        $container->register('bar', __NAMESPACE__.'\Bar')->setAutowired(true);
