...
use zxf\Symfony\Component\DependencyInjection\Compiler\ResolveChildDefinitionsPass;
use zxf\Symfony\Component\DependencyInjection\Compiler\ResolveDefinitionTemplatesPass;
...
class ResolveChildDefinitionsPassTest extends TestCase
{
    ...
    public function testDeepDefinitionsResolving()
    {
        ...
        $this->assertSame('zxf\Symfony\Component\DependencyInjection\Definition', get_class($configurator));
        $this->assertSame('parentClass', $configurator->getClass());

        $factory = $container->getDefinition('sibling')->getFactory();
        $this->assertSame('zxf\Symfony\Component\DependencyInjection\Definition', get_class($factory[0]));
        $this->assertSame('parentClass', $factory[0]->getClass());

        $argument = $container->getDefinition('sibling')->getArgument(0);
        $this->assertSame('zxf\Symfony\Component\DependencyInjection\Definition', get_class($argument));
        $this->assertSame('parentClass', $argument->getClass());

        $properties = $container->getDefinition('sibling')->getProperties();
        $this->assertSame('zxf\Symfony\Component\DependencyInjection\Definition', get_class($properties['prop']));
        $this->assertSame('parentClass', $properties['prop']->getClass());

        $methodCalls = $container->getDefinition('sibling')->getMethodCalls();
        $this->assertSame('zxf\Symfony\Component\DependencyInjection\Definition', get_class($methodCalls[0][1][0]));
