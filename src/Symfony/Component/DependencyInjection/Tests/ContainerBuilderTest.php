...
namespace zxf\Symfony\Component\DependencyInjection\Tests;

require_once __DIR__.'/Fixtures/includes/classes.php';
require_once __DIR__.'/Fixtures/includes/ProjectExtension.php';

use PHPUnit\Framework\TestCase;
use zxf\Psr\Container\ContainerInterface as PsrContainerInterface;
use zxf\Symfony\Component\Config\Resource\ComposerResource;
use zxf\Symfony\Component\Config\Resource\ResourceInterface;
use zxf\Symfony\Component\Config\Resource\DirectoryResource;
use zxf\Symfony\Component\DependencyInjection\Alias;
...
use zxf\Symfony\Component\DependencyInjection\Exception\ServiceNotFoundException;
use zxf\Symfony\Component\DependencyInjection\Loader\ClosureLoader;
use zxf\Symfony\Component\DependencyInjection\Reference;
use zxf\Symfony\Component\DependencyInjection\Tests\Fixtures\SimilarArgumentsDummy;
...
use zxf\Symfony\Component\DependencyInjection\ParameterBag\EnvPlaceholderParameterBag;
use zxf\Symfony\Component\Config\Resource\FileResource;
...
use zxf\Symfony\Component\DependencyInjection\Tests\Fixtures\CaseSensitiveClass;
...
class ContainerBuilderTest extends TestCase
{
    ...
    public function testRegister()
    {
        ...
        $this->assertInstanceOf('zxf\Symfony\Component\DependencyInjection\Definition', $builder->getDefinition('foo'), '->register() returns the newly created Definition instance');
    }
    ...
    public function testGetServiceIds()
    {
        ...
        $this->assertEquals(
            array(
                ...
                'zxf\Symfony\Component\DependencyInjection\ContainerInterface',
            ),
    ...
    public function testAddGetCompilerPass()
    {
        ...
        $builder->addCompilerPass($pass1 = $this->getMockBuilder('zxf\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface')->getMock(), PassConfig::TYPE_BEFORE_OPTIMIZATION, -5);
        $builder->addCompilerPass($pass2 = $this->getMockBuilder('zxf\Symfony\Component\DependencyInjection\Compiler\CompilerPassInterface')->getMock(), PassConfig::TYPE_BEFORE_OPTIMIZATION, 10);
    ...
    public function testAddObjectResource()
    {
        ...
        $this->assertInstanceOf('zxf\Symfony\Component\Config\Resource\FileResource', $resource);
    ...
    public function testArgumentsHaveHigherPriorityThanBindings()
    {
        ...
        $this->assertSame(array('service_container', 'class.via.bindings', 'class.via.argument', 'foo', 'Psr\Container\ContainerInterface', 'zxf\Symfony\Component\DependencyInjection\ContainerInterface'), $container->getServiceIds());
