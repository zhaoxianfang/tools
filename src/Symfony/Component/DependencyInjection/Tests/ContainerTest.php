...
class ContainerTest extends TestCase
{
    ...
    public function testCompile()
    {
        ...
        $this->assertInstanceOf('zxf\Symfony\Component\DependencyInjection\ParameterBag\FrozenParameterBag', $sc->getParameterBag(), '->compile() changes the parameter bag to a FrozenParameterBag instance');
        $this->assertEquals(array('foo' => 'bar'), $sc->getParameterBag()->all(), '->compile() copies the current parameters to the new parameter bag');
    }

    /**
     * @group legacy
     * @expectedDeprecation The zxf\Symfony\Component\DependencyInjection\Container::isFrozen() method is deprecated since Symfony 3.3 and will be removed in 4.0. Use the isCompiled() method instead.
     * @expectedDeprecation The zxf\Symfony\Component\DependencyInjection\Container::isFrozen() method is deprecated since Symfony 3.3 and will be removed in 4.0. Use the isCompiled() method instead.
     */
    ...
    public function testGet()
    {
        ...
        try {
            ...
            $this->assertInstanceOf('zxf\Symfony\Component\DependencyInjection\Exception\ServiceNotFoundException', $e, '->get() throws a ServiceNotFoundException exception if the service is empty');
        }
    ...
    public function testGetThrowServiceNotFoundException()
    {
        ...
        try {
            ...
            $this->assertInstanceOf('zxf\Symfony\Component\DependencyInjection\Exception\ServiceNotFoundException', $e, '->get() throws an Symfony\Component\DependencyInjection\Exception\ServiceNotFoundException if the key does not exist');
    ...
    {
        $class = new \ReflectionClass('zxf\Symfony\Component\DependencyInjection\Container');
