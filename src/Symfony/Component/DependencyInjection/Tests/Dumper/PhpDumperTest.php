...
namespace zxf\Symfony\Component\DependencyInjection\Tests\Dumper;

use DummyProxyDumper;
use PHPUnit\Framework\TestCase;
use zxf\Psr\Container\ContainerInterface;
use zxf\Symfony\Component\Config\FileLocator;
use zxf\Symfony\Component\DependencyInjection\Argument\IteratorArgument;
use zxf\Symfony\Component\DependencyInjection\Argument\RewindableGenerator;
use zxf\Symfony\Component\DependencyInjection\Argument\ServiceClosureArgument;
...
use zxf\Symfony\Component\DependencyInjection\ContainerInterface as SymfonyContainerInterface;
use zxf\Symfony\Component\DependencyInjection\Dumper\PhpDumper;
use zxf\Symfony\Component\DependencyInjection\EnvVarProcessorInterface;
use zxf\Symfony\Component\DependencyInjection\Parameter;
...
use zxf\Symfony\Component\DependencyInjection\Tests\Fixtures\StubbedTranslator;
use zxf\Symfony\Component\DependencyInjection\TypedReference;
use zxf\Symfony\Component\DependencyInjection\Definition;
use zxf\Symfony\Component\DependencyInjection\Loader\YamlFileLoader;
use zxf\Symfony\Component\DependencyInjection\ServiceLocator;
use zxf\Symfony\Component\DependencyInjection\Tests\Fixtures\CustomDefinition;
use zxf\Symfony\Component\DependencyInjection\Tests\Fixtures\TestServiceSubscriber;
use zxf\Symfony\Component\DependencyInjection\Variable;
use zxf\Symfony\Component\ExpressionLanguage\Expression;
...
class PhpDumperTest extends TestCase
{
    ...
    public function testDump()
    {
        ...
        $this->assertStringEqualsFile(self::$fixturesPath.'/php/services1-1.php', $dumper->dump(array('class' => 'Container', 'base_class' => 'AbstractContainer', 'namespace' => 'zxf\Symfony\Component\DependencyInjection\Dump')), '->dump() takes a class and a base_class options');
    }
    ...
    public function testDumpCustomContainerClassWithoutConstructor()
    {
        ...
        $this->assertStringEqualsFile(self::$fixturesPath.'/php/custom_container_class_without_constructor.php', $dumper->dump(array('base_class' => 'NoConstructorContainer', 'namespace' => 'zxf\Symfony\Component\DependencyInjection\Tests\Fixtures\Container')));
    }
    ...
    public function testDumpCustomContainerClassConstructorWithoutArguments()
    {
        ...
        $this->assertStringEqualsFile(self::$fixturesPath.'/php/custom_container_class_constructor_without_arguments.php', $dumper->dump(array('base_class' => 'ConstructorWithoutArgumentsContainer', 'namespace' => 'zxf\Symfony\Component\DependencyInjection\Tests\Fixtures\Container')));
    }
    ...
    public function testDumpCustomContainerClassWithOptionalArgumentLessConstructor()
    {
        ...
        $this->assertStringEqualsFile(self::$fixturesPath.'/php/custom_container_class_with_optional_constructor_arguments.php', $dumper->dump(array('base_class' => 'ConstructorWithOptionalArgumentsContainer', 'namespace' => 'zxf\Symfony\Component\DependencyInjection\Tests\Fixtures\Container')));
    }
    ...
    public function testDumpCustomContainerClassWithMandatoryArgumentLessConstructor()
    {
        ...
        $this->assertStringEqualsFile(self::$fixturesPath.'/php/custom_container_class_with_mandatory_constructor_arguments.php', $dumper->dump(array('base_class' => 'ConstructorWithMandatoryArgumentsContainer', 'namespace' => 'zxf\Symfony\Component\DependencyInjection\Tests\Fixtures\Container')));
    }
    ...
    public function testConflictingMethodsWithParent()
    {
        ...
        eval('?>'.$dumper->dump(array(
            'class' => $class,
            'base_class' => 'zxf\Symfony\Component\DependencyInjection\Tests\Fixtures\containers\CustomContainer',
        )));
