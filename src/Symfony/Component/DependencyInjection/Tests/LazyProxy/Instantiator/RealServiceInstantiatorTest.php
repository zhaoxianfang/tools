...
namespace zxf\Symfony\Component\DependencyInjection\Tests\LazyProxy\Instantiator;
...
class RealServiceInstantiatorTest extends TestCase
{
    public function testInstantiateProxy()
    {
        ...
        $container = $this->getMockBuilder('zxf\Symfony\Component\DependencyInjection\ContainerInterface')->getMock();
