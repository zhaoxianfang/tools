...
namespace zxf\Symfony\Component\DependencyInjection\Tests\Loader;

use zxf\Psr\Container\ContainerInterface as PsrContainerInterface;
use PHPUnit\Framework\TestCase;
use zxf\Symfony\Component\Config\FileLocator;
use zxf\Symfony\Component\Config\Loader\LoaderResolver;
...
use zxf\Symfony\Component\DependencyInjection\Loader\FileLoader;
use zxf\Symfony\Component\DependencyInjection\Loader\IniFileLoader;
use zxf\Symfony\Component\DependencyInjection\Loader\PhpFileLoader;
use zxf\Symfony\Component\DependencyInjection\Loader\XmlFileLoader;
...
use zxf\Symfony\Component\DependencyInjection\Tests\Fixtures\Prototype\BadClasses\MissingParent;
use zxf\Symfony\Component\DependencyInjection\Tests\Fixtures\Prototype\OtherDir\AnotherSub\DeeperBaz;
use zxf\Symfony\Component\DependencyInjection\Tests\Fixtures\Prototype\OtherDir\Baz;
use zxf\Symfony\Component\DependencyInjection\Tests\Fixtures\Prototype\Foo;
use zxf\Symfony\Component\DependencyInjection\Tests\Fixtures\Prototype\FooInterface;
use zxf\Symfony\Component\DependencyInjection\Tests\Fixtures\Prototype\Sub\Bar;
use zxf\Symfony\Component\DependencyInjection\Tests\Fixtures\Prototype\Sub\BarInterface;
...
class FileLoaderTest extends TestCase
{
    ...
    public function testRegisterClasses()
    {
        ...
        $loader->registerClasses(new Definition(), 'zxf\Symfony\Component\DependencyInjection\Tests\Fixtures\Prototype\Sub\\', 'Prototype/%sub_dir%/*');
    ...
    public function testRegisterClassesWithExclude()
    {
        ...
        $loader->registerClasses(
            new Definition(),
            'zxf\Symfony\Component\DependencyInjection\Tests\Fixtures\Prototype\\',
            'Prototype/*',
    ...
    public function testNestedRegisterClasses()
    {
        ...
        $loader->registerClasses($prototype, 'zxf\Symfony\Component\DependencyInjection\Tests\Fixtures\Prototype\\', 'Prototype/*');
    ...
    public function testMissingParentClass()
    {
        ...
        $loader->registerClasses(
            ...
            'zxf\Symfony\Component\DependencyInjection\Tests\Fixtures\Prototype\BadClasses\\',
    ...
    public function testRegisterClassesWithBadPrefix()
    {
        ...
        $loader->registerClasses(new Definition(), 'zxf\Symfony\Component\DependencyInjection\Tests\Fixtures\Prototype\\', 'Prototype/Sub/*');
    }
