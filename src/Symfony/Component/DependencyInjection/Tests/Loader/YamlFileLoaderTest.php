...
use zxf\Symfony\Component\DependencyInjection\Tests\Fixtures\Bar;
use zxf\Symfony\Component\DependencyInjection\Tests\Fixtures\BarInterface;
use zxf\Symfony\Component\DependencyInjection\Tests\Fixtures\CaseSensitiveClass;
use zxf\Symfony\Component\DependencyInjection\Tests\Fixtures\Prototype;
use zxf\Symfony\Component\DependencyInjection\Tests\Fixtures\NamedArgumentsDummy;
...
class YamlFileLoaderTest extends TestCase
{
    ...
    public function testNonArrayTagsThrowsException()
    {
        ...
        try {
            ...
            $this->assertInstanceOf('zxf\Symfony\Component\DependencyInjection\Exception\InvalidArgumentException', $e, '->load() throws an InvalidArgumentException if the tags key is not an array');
    ...
    public function testTagWithoutNameThrowsException()
    {
        ...
        try {
            ...
            $this->assertInstanceOf('zxf\Symfony\Component\DependencyInjection\Exception\InvalidArgumentException', $e, '->load() throws an InvalidArgumentException if a tag is missing the name key');
    ...
    public function testTagWithAttributeArrayThrowsException()
    {
        ...
        try {
            ...
            $this->assertInstanceOf('zxf\Symfony\Component\DependencyInjection\Exception\InvalidArgumentException', $e, '->load() throws an InvalidArgumentException if a tag-attribute is not a scalar');
