...
namespace zxf\Symfony\Component\DependencyInjection\Tests\ParameterBag;

use PHPUnit\Framework\TestCase;
use zxf\Symfony\Component\DependencyInjection\ParameterBag\ParameterBag;
use zxf\Symfony\Component\DependencyInjection\Exception\ParameterNotFoundException;
...
class ParameterBagTest extends TestCase
{
    ...
    public function testGetSet()
    {
        ...
        try {
            ...
            $this->assertInstanceOf('zxf\Symfony\Component\DependencyInjection\Exception\ParameterNotFoundException', $e, '->get() throws an Symfony\Component\DependencyInjection\Exception\ParameterNotFoundException if the key does not exist');
