...
namespace zxf\Symfony\Component\Filesystem;

use zxf\Symfony\Component\Filesystem\Exception\IOException;
use zxf\Symfony\Component\Lock\Store\FlockStore;
use zxf\Symfony\Component\Lock\Store\SemaphoreStore;
 ...
 *
 * @deprecated since version 3.4, to be removed in 4.0. Use zxf\Symfony\Component\Lock\Store\SemaphoreStore or Symfony\Component\Lock\Store\FlockStore instead.
 */
class LockHandler
{
    private $file;
