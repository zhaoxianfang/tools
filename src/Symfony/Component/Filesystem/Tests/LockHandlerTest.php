...
namespace zxf\Symfony\Component\Filesystem\Tests;

use PHPUnit\Framework\TestCase;
use zxf\Symfony\Component\Filesystem\Exception\IOException;
use zxf\Symfony\Component\Filesystem\Filesystem;
use zxf\Symfony\Component\Filesystem\LockHandler;
...
class LockHandlerTest extends TestCase
{
    ...
    public function testErrorHandlingInLockIfLockPathBecomesUnwritable()
    {
        ...
        $this->assertInstanceOf('zxf\Symfony\Component\Filesystem\Exception\IOException', $e, sprintf('Expected IOException to be thrown, got %s instead.', get_class($e)));
