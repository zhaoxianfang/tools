    ...
    public function testNonUtf8Exception()
    {
        ...
        foreach ($yamls as $yaml) {
            try {
                ...
                $this->assertInstanceOf('zxf\Symfony\Component\Yaml\Exception\ParseException', $e, 'charsets other than UTF-8 are rejected.');
            }
        }
    }
...
YAML;
    ...
    public function testPhpConstantTagMappingKey()
    {
        $yaml = <<<YAML
transitions:
    !php/const 'zxf\Symfony\Component\Yaml\Tests\B::FOO':
        from:
            - !php/const 'zxf\Symfony\Component\Yaml\Tests\B::BAR'
        to: !php/const 'zxf\Symfony\Component\Yaml\Tests\B::BAZ'
YAML;
        $expected = array(
            'transitions' => array(
                'foo' => array(
