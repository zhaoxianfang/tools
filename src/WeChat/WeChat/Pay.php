...
use zxf\WeChat\WeChat\Contracts\BasicWePay;
use zxf\WeChat\WePay\Bill;
use zxf\WeChat\WePay\Order;
use zxf\WeChat\WePay\Refund;
use zxf\WeChat\WePay\Transfers;
use zxf\WeChat\WePay\TransfersBank;
