...
class BarCode extends BarcodeType
{
    ...
    private function _getFontPath()
    {
        if (empty($this->label_font_path)) {
            return dirname(__DIR__) . "/resource/font/pmzdxx.ttf";
        }
        return $this->label_font_path;
    }

    /**
     * Set BarCode label font path.
     *
     ...
     * @return $this
     */
    public function useFontFile(string $fontName = 'pmzdxx'): BarCode
    {
    ...
    public function draw()
    {
        ...
        $img = base64_decode($this->generate());
        echo $img;
        die;
