...
namespace zxf\tool\Wechat\Payment\Address;

use zxf\tool\Wechat\Bridge\Util;
use zxf\tool\Wechat\Bridge\Serializer;
use zxf\tool\Wechat\OAuth\AccessToken;

class ConfigGenerator
{
    /**
     * zxf\tool\Wechat\OAuth\AccessToken.
     */
